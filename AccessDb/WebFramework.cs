...
namespace SYuksel.AccessDb
{
    public class WebFramework
    {
        ...
        public static DataSet DataSetFill(String sql, params object[] values)
        {
            ...
            if (calistir)
            {
                OleDbConnection baglan = new OleDbConnection(WebConfigurationManager.ConnectionStrings[Config.connectionName].ToString());
        ...
        private DataTable DataTableGetir(string sql, params object[] values)
        {
            ...
            if (calistir)
            {
                OleDbConnection con = this.Connect();
        ...
        public static Result ExecuteNonQuery(string sql, params object[] values)
        {
            ...
            try
            {
                ...
                if (calistir)
                {
                    ...
                    OleDbCommand emir1 = new OleDbCommand();
        ...
        public static Result InsertData(Object tablo)
        {
            ...
            try
            {
                using (OleDbConnection baglanti = new OleDbConnection(WebConfigurationManager.ConnectionStrings[Config.connectionName].ToString()))
                {
